...
from ..core.auth import AuthManager, reload_assigned_api_keys
...
async def get_tokens(token: str = Depends(verify_admin_token)):
    ...
    return [{
        ...
        "assigned_api_key": row.get("assigned_api_key"),
...
async def add_token(
    ...
    try:
        new_token = await token_manager.add_token(
            ...
            assigned_api_key=request.assigned_api_key.strip() if request.assigned_api_key is not None else None,
